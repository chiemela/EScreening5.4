...
public class MainActivity extends AppCompatActivity {
    ...
    String userId;
    Button resendCode;
    Button resetPassLocal,changeProfileImage,startScreeningBtn;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startScreeningBtn = findViewById(R.id.startScreening);

        profileImage = findViewById(R.id.profileImage);
        changeProfileImage = findViewById(R.id.changeProfile);

        startScreeningBtn.setEnabled(false);
        ...
        if(user.isEmailVerified()) {
            startScreeningBtn.setEnabled(true);
        }
        ...
        resetPassLocal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                passwordResetDialog.setMessage("You will receive a Reset Link in your Email. Use your new password to Login.");
